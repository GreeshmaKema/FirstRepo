...
public class ActionDriver {
	...
	public boolean isElementPresent(By locator, String eleName)
	{
		try {
			driver.findElement(locator);
			StartBrowser.childTest.pass(eleName + " is visible");
			return true;
		} catch (Exception e) {
			StartBrowser.childTest.pass(eleName +" Is not visible",
					MediaEntityBuilder.createScreenCaptureFromBase64String(screenShot()).build());
			StartBrowser.childTest.info(e);
			return false;
